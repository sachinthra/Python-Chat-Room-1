...
#my_username[0]= my_username[0].upper()
#e1 = Entry(parent).place(x=0,y=450)
...
def add(event):
    ...
    msg = entry.get()
    #print(type(username))
    lst.insert(END, (str(b' %s -> ' % (username),'utf-8') + msg))
    v.set("")
v = StringVar()
    ...
    while True:
        try:
            ...
            while True:
                ...
                # Print message
                lst.insert(END, (str(b' %s -> %s ' % (username,message),'utf-8')  ))
